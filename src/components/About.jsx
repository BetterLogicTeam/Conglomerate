...
export default function About() {
  return (
    <div className="rounded-t-lg paddng_res p-5 sm:pl-[43px] lg:pt-[34px] lg:pl-[46px] ">
      <h3 className="main_hsgsr text-[#FFFF00]">Cure coin : Lets cure cancer with Crypto ! </h3>
      <p className="pt-5 text-white pb-[9px] text-22">
